const ansTable = {
    ...
    numObject: 6,
    srcObject: {
        0: 'sources/img/letter-1.svg',
        1: 'sources/img/letter-2.svg',
        2: 'sources/img/letter-3.svg',
        3: 'sources/img/letter-4.svg',
        4: 'sources/img/letter-5.svg',
        5: 'sources/img/letter-6.svg',
    },
    srcAnswer: {
        0: 'sources/img/letter-1.svg',
        1: 'sources/img/letter-3.svg',
    },
    dict: {
        0: 0,
        1: 2
...
function rightAnswer(i) {
    ...
    var right = new Audio('sources/sound/right.mp3');
...
function wrongAnswer() {
    ...
    var wrong = new Audio('sources/sound/wrong.mp3');
